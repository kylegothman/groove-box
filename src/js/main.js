...
const currentStepDisplay = document.querySelector(".main-controls .current-step .number");
...
const toggleButton = (button) => {
  ...
  button.querySelector(".text").textContent = button.classList.contains("on") ? "ON" : "OFF";
};
